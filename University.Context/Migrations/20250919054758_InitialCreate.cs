    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourseProfessors", x => new { x.CourseID, x.ProfID, x.StId });
                    table.ForeignKey(
                        name: "FK_StudentCourseProfessors_Courses_CourseID",
                        column: x => x.CourseID,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentCourseProfessors_Professors_ProfID",
                        column: x => x.ProfID,
                        principalTable: "Professors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentCourseProfessors_Students_StId",
                        column: x => x.StId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseProfessors_ProfID",
                table: "StudentCourseProfessors",
                column: "ProfID");

            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseProfessors_StId",
                table: "StudentCourseProfessors",
                column: "StId");
